...
$lang['store_setting_banner_tip']			= '此处为店铺页banner导航；<br/><span style="color:orange;">建议使用宽1200像素*高240像素的图片；点击下方"提交"按钮后生效。</span>';
...
$lang['store_slide_description_two']	= '支持jpg、jpeg、gif、png格式上传，建议图片宽度990px、高度在440px、大小%.2fM以内的图片。提交2~5张图片可以进行幻灯片播放，一张图片没有幻灯片播放效果。';
