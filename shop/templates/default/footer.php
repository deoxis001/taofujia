...
<div class="wwi-footer">
    ...
    <div id="faq">
        <div class="wrapper"><?php if (is_array($output['article_list']) && !empty($output['article_list'])) { ?>
                ...
                <dl>
                    <dt>商家合作</dt>
                    <dd><span>错过天猫？别再错过我们！</span>
                        <br>
                        <span>淘福家开启全新旅程！</span>
                        <a href="<?php echo urlShop('show_joinin', 'index'); ?>" class="btn"
...
<!--                <div class="fl right-flag"><a href="" target="_blank" rel="nofollow"><img-->
...
<!--                            src="--><?php //echo SHOP_SITE_URL; ?><!--/img/isc2.png"></a></div>-->
                <div class="fl about-us"><p><a
                            href="/">返回首页</a><?php if (!empty($output['nav_list']) && is_array($output['nav_list'])) { ?><?php foreach ($output['nav_list'] as $nav) { ?><?php if ($nav['nav_location'] == '2') { ?>
                            <span>|</span>
                    ...
                    <p>CopyRight © 2016 淘福家 <a href="http://www.miibeian.gov.cn/" target="_blank" mxf="sqde"
