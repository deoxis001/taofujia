    ...
    <div class="ncs-goods-summary">
      ...
      <div class="ncs-meta">
        ...
        <dl class="rate">
          ...
          <span class="ncs-goods-code-note"><i></i>手机端扫购有惊喜</span> </div>
      </div>
        <!-- E 商品发布价格 -->
        <?php } else {?>
        <!-- S 预定商品 -->
...
<div id="content" class="ncs-goods-layout expanded" >
  <div class="ncs-goods-main" id="main-nav-holder">
    ...
    <div class="ncs-intro">
      <div class="content bd" id="ncGoodsIntro">
        ...
        <div class="ncs-goods-info-content">
          ...
          <?php }?>
          <div class="default" style="padding-top:10px "><?php echo $output['goods']['goods_body']; ?></div>
    ...
    <div class="ncs-shop-map">
      ...
      <div class="bd" id="ncStoreMap" style="padding: 20px"><div id="baidu_map" style="height:600px;border:1px solid gray"></div></div>
    </div>
    <!-- E 店铺地址地图 -->
    <?php }?>
