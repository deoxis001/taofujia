        ...
        <div class="ncp-member-left">
            ...
            <?php } else { ?>
                <div class="ncp-not-login">
                    ...
                    <div class="button"><a href="javascript:login_dialog();" class="ncbtn"
                                           style="width:120px;"><?php echo $lang['pointprod_list_hello_login']; ?></a>
                    </div>
                </div>
            <?php } ?>
        </div>
    ...
    <?php if (C('voucher_allow') == 1) { ?>
        <div class="ncp-main-layout">
            <div class="title">
                ...
                <span class="more"><a
                        href="<?php echo urlShop('pointvoucher', 'index'); ?>"><?php echo $lang['home_voucher_moretitle']; ?></a></span>
            </div>
                    ...
                    <?php foreach ($output['recommend_voucher'] as $k => $v) { ?>
                        <li>
                            <div class="ncp-voucher">
                                <div class="cut"></div>
                                <div class="info"><a
                                        href="<?php echo urlShop('show_store', 'index', array('store_id' => $v['voucher_t_store_id'])); ?>"
                                        class="store"><?php echo $v['voucher_t_storename']; ?></a>
                                    <p class="store-classify"><?php echo $v['voucher_t_sc_name']; ?></p>
                                    <div class="pic"><img src="<?php echo $v['voucher_t_customimg']; ?>"
                                                          onerror="this.src='<?php echo UPLOAD_SITE_URL . DS . defaultGoodsImage(240); ?>'"/>
                                    </div>
                                </div>
                                <dl class="value">
                                    <dt><?php echo $lang['currency']; ?><em><?php echo $v['voucher_t_price']; ?></em>
                                    </dt>
                                ...
                                <div class="point">
                                    ...
                                    <?php if ($v['voucher_t_mgradelimit'] > 0) { ?>
                                        <span
                                            style="background-color: #e8e8e8;clear: left;display: block;float: right;font-family: Georgia,Arial;font-size: 18px;height: 53px;line-height: 53px;text-align: center;width: 40px;">
                <?php echo $v['voucher_t_mgradelimittext']; ?>
            </span>
                                    <?php } ?>
                                </div>
                                <div class="button"><a target="_blank" href="javascript:void(0);" nc_type="exchangebtn"
                                                       data-param='{"vid":"<?php echo $v['voucher_t_id']; ?>"}'
                                                       class="ncbtn ncbtn-grapefruit">立即兑换</a></div>
                            </div>
                        </li>
                    <?php } ?>
                </ul>
    ...
    <?php if (C('pointprod_isuse') == 1) { ?>
        <div class="ncp-main-layout mb30">
            <div class="title">
                ...
                <span class="more"><a
                        href="<?php echo urlShop('pointprod', 'plist'); ?>"><?php echo $lang['pointprod_list_more']; ?></a></span>
            </div>
                    ...
                    <?php foreach ($output['recommend_pointsprod'] as $k => $v) { ?>
                        <li>
                            ...
                            <div class="gift-name"><a
                                    href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id'])); ?>"
                                    target="_blank"
                                    tile="<?php echo $v['pgoods_name']; ?>"><?php echo $v['pgoods_name']; ?></a></div>
                            <div class="exchange-rule">
                                <?php if (intval($v['pgoods_limitmgrade']) > 0) { ?>
                                    <span class="pgoods-grade"><?php echo $v['pgoods_limitgradename']; ?></span>
                                <?php } ?>
                                <span
                                    class="pgoods-price"><?php echo $lang['pointprod_goodsprice'] . $lang['nc_colon']; ?>
                                    <em><?php echo $lang['currency'] . ncPriceFormat($v['pgoods_price']); ?></em></span>
                                <span
                                    class="pgoods-points"><?php echo $lang['pointprod_pointsname'] . $lang['nc_colon']; ?>
                                    <strong><?php echo $v['pgoods_points']; ?></strong><?php echo $lang['points_unit']; ?></span>
                            </div>
                        </li>
                    <?php } ?>
                </ul>
    ...
    <?php if (C('redpacket_allow') == 1) { ?>
        <div class="ncp-main-layout">
            <div class="title">
                ...
                <span class="more"><a
                        href="<?php echo urlShop('pointredpacket', 'index'); ?>"><?php echo $lang['home_voucher_moretitle']; ?></a></span>
            </div>
            <?php if (!empty($output['recommend_rpt'])) { ?>
                        ...
                        <li>
                            <div class="ncp-voucher">
                                ...
                                <div class="info">
                                    ...
                                    <div class="pic"><img src="<?php echo $v['rpacket_t_customimg_url']; ?>"
                                                          onerror="this.src='<?php echo UPLOAD_SITE_URL . DS . defaultGoodsImage(240); ?>'"/>
                                    </div>
                                </div>
                                <dl class="value">
                                    <dt><?php echo $lang['currency']; ?><em><?php echo $v['rpacket_t_price']; ?></em>
                                    </dt>
                ...
                <?php echo $v['rpacket_t_mgradelimittext']; ?>
                                ...
                                <div class="button"><a target="_blank" href="javascript:void(0);"
                                                       nc_type="rptexchangebtn"
                                                       data-param='{"tid":"<?php echo $v['rpacket_t_id']; ?>"}'
                                                       class="ncbtn ncbtn-grapefruit">立即兑换</a></div>
                            </div>
                        </li>
                    <?php } ?>
