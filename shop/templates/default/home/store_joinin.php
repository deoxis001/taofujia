        ...
        <?php if ($_SESSION['is_login'] == '1') { ?>
            <div class="user-joinin">
                ...
                <dl>
                    ...
                    <dd> 若您还没有填写入驻申请资料<br/>
                        请点击“<a href="<?php echo urlShop('store_joinin', 'step0'); ?>" target="_blank">我要入驻</a>”进行入驻资料填写
                    </dd>
                    <dd>若您的店铺还未开通<br/>
                        请通过“<a href="<?php echo urlShop('store_joinin', 'index'); ?>" target="_blank">查看入驻进度</a>”了解店铺开通的最新状况
                    </dd>
                </dl>
                <div class="bottom"><a href="<?php echo urlShop('store_joinin', 'step0'); ?>" target="_blank">我要入驻</a><a
                        href="<?php echo urlShop('store_joinin', 'index'); ?>" target="_blank">查看入驻进度</a></div>
            </div>
        <?php } else { ?>
                ...
                <form id="login_form" action="<?php echo urlLogin('login') ?>" method="post">
                    ...
                    <?php if (C('captcha_status_login') == '1') { ?>
                        <dl>
                            <dt>验证码：</dt>
                            <dd>
                                <input type="text" name="captcha" class="text w50 fl" id="captcha" maxlength="4"
                                       size="10"/>
                                <a href="JavaScript:void(0);"
                                   onclick="javascript:document.getElementById('codeimage').src='index.php?act=seccode&op=makecode&nchash=<?php echo getNchash(); ?>&t=' + Math.random();"
                                   class="change" title="<?php echo $lang['login_index_change_checkcode']; ?>">
                                    <img src="index.php?act=seccode&op=makecode&nchash=<?php echo getNchash(); ?>"
                                         class="fl ml5" name="codeimage" id="codeimage" border="0"/></a>
                                <label></label>
                            </dd>
                        </dl>
                    <?php } ?>
                    <dl>
                        <dt></dt>
                        <dd>
                            <input type="hidden" value="<?php echo SHOP_SITE_URL ?>/index.php?act=show_joinin"
                                   name="ref_url">
                            <input name="提交" type="submit" class="button" value="登&nbsp;&nbsp;录">
                            <a href="<?php echo urlLogin('login', 'forget_password'); ?>"
                               target="_blank"><?php echo $lang['login_index_forget_password']; ?></a></dd>
                    </dl>
                </form>
                <div class="register">还没有成为我们的合作伙伴？ <a href="<?php echo urlLogin('login', 'register'); ?>"
                                                       target="_blank">快速注册</a></div>
            </div>
        <?php } ?>
    </div>
...
<div class="flow-box">
    ...
    $i++; ?>
    <?php if ($i == 1){ ?>
    <div class="settled-flow sb_floor">
        <div class="settled">
            <div class="left"><i class="i_1"></i>
                <p><?php echo $val['help_title']; ?></p>
                <p class="eng">PROCESS</p><span class="span_1"></span></div>
            <?php }else if ($i == 2){ ?>
            <div class="settled-stander sb_floor">
                <div class="stand">
                    <div class="left"><i class="i_2"></i>
                        <p><?php echo $val['help_title']; ?></p>
                        <p class="eng">STANDARD</p><span class="span_2"></span></div>
                    <?php }else if ($i == 3){ ?>
                    <div class="settled-rules sb_floor">
                        <div class="rule">
                            <div class="left"><i class="i_3"></i>
                                <p><?php echo $val['help_title']; ?></p>
                                <p class="eng">PROCESS</p> <span class="span_3"></span></div>
                            <?php }else if ($i == 4){ ?>
                            <div class="settled-brands sb_floor">
                                <div class="brand">
                                    <div class="left"><i class="i_4"></i>
                                        <p>合作品牌</p>
                                        <p class="eng">COOPERATIVE RULES</p><span class="span_4"></span></div>
                                    <?php } ?>
                                    <div class="right"><?php echo $val['help_info']; ?></div>
                                </div>
                            </div>
                            <?php } ?>
                            <?php } ?></div>
    ...
    <span class="step">
      <a href="javascript:;">
          已合作品牌</a>
                    ...
                    <?php } ?>
                    <script type="text/javascript" src="<?php echo SHOP_SITE_URL; ?>/img/index_introduce.js"
                            charset="utf-8"></script>
