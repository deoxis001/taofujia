...
<div class="ncp-container">
    <div class="ncp-detail">
        <div class="ncp-gift-picture"><a href="<?php echo $output['prodinfo']['pgoods_image_max']; ?>"><img
                    src="<?php echo $output['prodinfo']['pgoods_image_max']; ?>"></a></div>
        <div class="ncp-share">
            <div id="bdshare" class="bdshare_t bds_tools get-codes-bdshare"><span
                    class="bds_more"><?php echo $lang['pointprod_info_goods_share_to']; ?></span> <a
                    class="bds_tqq"></a> <a class="bds_tsina"></a> <a class="bds_renren"></a> <a class="bds_ty"></a> <a
                    mxf="sqde" class="bds_qq"></a> <a class="bds_baidu"></a> <a class="bds_taobao"></a> <a
                    class="bds_copy"></a> <a class="shareCount"></a></div>
        </div>
        <div class="ncp-gift-summary">
            ...
            <div class="ncp-meta">
                <dl>
                    <dt>原&nbsp;&nbsp;&nbsp;&nbsp;价：</dt>
                    <dd class="cost-price">
                        <strong><?php echo $lang['currency'] . ncPriceFormat($output['prodinfo']['pgoods_price']); ?></strong>
                    </dd>
                </dl>
                <dl>
                    <dt>所需积分：</dt>
                    <dd class="points">
                        <strong><?php echo $output['prodinfo']['pgoods_points']; ?><?php echo $lang['points_unit']; ?></strong>
                ...
                <?php if ($output['prodinfo']['pgoods_islimittime'] == 1) { ?>
                    ...
                    <?php if ($output['prodinfo']['ex_state'] == 'going') { ?>
                        <dl>
                            <dt>&nbsp;</dt>
                            <dd class="countdown"><?php echo $lang['pointprod_info_goods_lasttime']; ?>&nbsp;&nbsp;<i
                                    id="dhpd"><?php echo $output['prodinfo']['timediff']['diff_day']; ?></i> <?php echo $lang['pointprod_info_goods_lasttime_day']; ?>
                                <i id="dhph"><?php echo $output['prodinfo']['timediff']['diff_hour']; ?></i> <?php echo $lang['pointprod_info_goods_lasttime_hour']; ?>
                                <i id="dhpm"><?php echo $output['prodinfo']['timediff']['diff_mins']; ?></i> <?php echo $lang['pointprod_info_goods_lasttime_mins']; ?>
                                <i id="dhps"><?php echo $output['prodinfo']['timediff']['diff_secs']; ?></i> <?php echo $lang['pointprod_info_goods_lasttime_secs']; ?>
                            </dd>
                        </dl>
                    <?php } ?>
                <?php } ?>
                    ...
                    <dl>
                        ...
                        <dd><?php echo $lang['pointprod_info_goods_limitnum_tip1']; ?><?php echo $output['prodinfo']['pgoods_limitnum']; ?><?php echo $lang['pointprod_pointprod_unit']; ?>
                            <input type="hidden" id="limitnum"
                                   value="<?php echo $output['prodinfo']['pgoods_limitnum']; ?>"/>
                        </dd>
                    </dl>
                <?php } else { ?>
            ...
            <div class="ncs-btn">
                ...
                <?php } else { ?>
                    <a class="buynow" onclick="return add_to_cart();" style="cursor:pointer;"><i
                            class="ico"></i><?php echo $lang['pointprod_exchange']; ?></a>
                <?php } ?>
            </div>
        </div>
                    ...
                    <?php if ($output['orderprod_list'] && is_array($output['orderprod_list'])) { ?>
                        <?php foreach ($output['orderprod_list'] as $v) { ?>
                            <li>
                                ...
                                <div
                                    class="user-log"><?php echo date('Y-m-d', $v['point_addtime']); ?> <?php echo $lang['pointprod_info_goods_alreadyexchange']; ?>
                                    <strong><?php echo $v['point_goodsnum']; ?></strong>件
                                </div>
                            </li>
                        <?php } ?>
                    <?php } ?>
                    ...
                    <?php if (is_array($output['recommend_pointsprod']) && count($output['recommend_pointsprod']) > 0) { ?>
                        <ul class="recommend">
                            <?php foreach ($output['recommend_pointsprod'] as $k => $v) { ?>
                                <li>
                                    <div class="gift-pic"><a target="_blank"
                                                             href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id'])); ?>"
                                                             title="<?php echo $v['pgoods_name']; ?>"> <img
                                                src="<?php echo $v['pgoods_image'] ?>"
                                                alt="<?php echo $v['pgoods_name']; ?>"/> </a></div>
                                    <div class="gift-name"><a
                                            href="<?php echo urlShop('pointprod', 'pinfo', array('id' => $v['pgoods_id'])); ?>"
                                            target="_blank"
                                            tile="<?php echo $v['pgoods_name']; ?>"><?php echo $v['pgoods_name']; ?></a>
                                    </div>
                                    <div
                                        class="pgoods-points"><?php echo $v['pgoods_points']; ?><?php echo $lang['points_unit']; ?><?php if (intval($v['pgoods_limitmgrade']) > 0) { ?>
                ...
                <div class="ncp-goods-title-nav">
                    <ul id="categorymenu">
                        <li class="current"><a id="tabGoodsIntro"
                                               href="#content"><?php echo $lang['pointprod_info_goods_description']; ?></a>
                        </li>
                    </ul>
                </div>
            </div>
...
<script type="text/javascript" src="<?php echo SHOP_RESOURCE_SITE_URL; ?>/js/home.js" id="dialog_js"
