...
<div class="main">
  ...
  <div class="final-site-nav">
    ...
    <ul>
      ...
      <li class="admin">
        <div class="ico"></div>
        <h5><a href="<?php echo $auto_site_url;?>/jinaoxun" target="_blank">系统管理</a></h5>
        <h6>电商系统后台</h6>
      </li>
    </ul>
  </div>
  <div class="final-intro">
    <p><strong>系统管理默认地址:&nbsp;</strong><a href="<?php echo $auto_site_url;?>/jinaoxun" target="_blank"><?php echo $auto_site_url;?>/admin</a></p>
