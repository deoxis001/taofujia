  ...
  <div class="nc-appbar-tabs" id="appBarTabs">
    ...
    <div class="variation">
      ...
      <h4><?php echo $lang['nc_otherlogintip'];?></h4>
        ...
        <div class="prech">&nbsp;</div>
        <?php if(C('node_chat')){ ?>
        <div class="chat"><a href="javascript:void(0);" id="chat_show_user"><span class="icon"></span><i id="new_msg" class="new_msg" style="display:none;"></i><span class="tit">在线联系2</span></a></div>
        <?php } ?>
      </div>
