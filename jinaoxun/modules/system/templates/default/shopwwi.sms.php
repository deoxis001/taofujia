    ...
    <form method="post" enctype="multipart/form-data" name="form1">
        ...
        <div class="ncap-form-default">
                ...
                <dd class="opt">
                    <ul class="ncap-account-container-list">
                        <?php if ($output['list_setting']['shopwwi_sms_type'] == 1) { ?>
                            ...
                            <li>
                            <input type="radio" name="shopwwi_sms_type" value="3"/>
                            <label for="shopwwi_sms_type"><?php echo $lang['shopwwi_sms_alidayu']; ?></label>
                            </li>
                        <?php } elseif (($output['list_setting']['shopwwi_sms_type'] == 2)) { ?>
                            <li>
                                <input type="radio" name="shopwwi_sms_type" value="1"/><label
                                    for="shopwwi_sms_type"><?php echo $lang['shopwwi_sms_dxb']; ?></label>
                            </li>
                            <li>
                            ...
                            <li>
                                <input type="radio" name="shopwwi_sms_type" value="3" checked="checked"/>
                                <label for="shopwwi_sms_type"><?php echo $lang['shopwwi_sms_alidayu']; ?></label>
                            </li>
                        <?php } ?>
                    </ul>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="shopwwi_sms_tgs" name="shopwwi_sms_tgs"
                           value="<?php echo $output['list_setting']['shopwwi_sms_tgs']; ?>" class="input-txt"
                           type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="shopwwi_sms_zh" name="shopwwi_sms_zh"
                           value="<?php echo $output['list_setting']['shopwwi_sms_zh']; ?>" class="input-txt"
                           type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="shopwwi_sms_pw" name="shopwwi_sms_pw"
                           value="<?php echo $output['list_setting']['shopwwi_sms_pw']; ?>" class="input-txt"
                           type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="shopwwi_sms_key" name="shopwwi_sms_key"
                           value="<?php echo $output['list_setting']['shopwwi_sms_key']; ?>" class="input-txt"
                           type="text"/>
            ...
            <dl class="row">
                <dt class="tit">
                    <label for="shopwwi_sms_secret"><?php echo $lang['shopwwi_sms_secret']; ?></label>
                </dt>
                <dd class="opt">
                    <input id="shopwwi_sms_secret" name="shopwwi_sms_secret"
                           value="<?php echo $output['list_setting']['shopwwi_sms_secret']; ?>" class="input-txt"
                           type="text"/>
                    <p class="notic"><?php echo $lang['shopwwi_sms_secret_notice']; ?></p>
                </dd>
            </dl>
            </dl>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <input id="shopwwi_sms_signature" name="shopwwi_sms_signature"
                           value="<?php echo $output['list_setting']['shopwwi_sms_signature']; ?>" class="input-txt"
                           type="text"/>
            ...
            <dl class="row">
                ...
                <dd class="opt">
                    <textarea name="shopwwi_sms_bz" rows="6" class="tarea"
                              id="shopwwi_sms_bz"><?php echo $output['list_setting']['shopwwi_sms_bz']; ?></textarea>
