...
class goodsModel extends Model{
    ...
    public function getGoodsListByColorDistinct($condition, $field = '*', $order = 'goods_id asc', $page = 0, $limit = 0) {
        ...
        $goods_list = array();
        if (C('dbdriver') == 'mysql') {
            //修改$goods_list = $this->getGoodsOnlineList($condition, $_field.' nc_distinct,'.$field, $page, $order, $limit, $_distinct, false, $count);
            $goods_list = $this->getGoodsOnlineList($condition, $_field.' nc_distinct,'.$field, $page, $order, $limit, 'goods_commonid', false, $count);
        } elseif (C('dbdriver') == 'oracle') {
